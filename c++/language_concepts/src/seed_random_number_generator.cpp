...
int main() {
    ...
    std::vector<std::vector<double>> matrix3(numRows, std::vector<double>(numCols));
    ...
    for (int i = 0; i < numRows; ++i) {
        for (int j = 0; j < numCols; ++j) {
            matrix1[i][j] = dist(gen); // Generate a random number between 0 and 1
        }
    }

    // Populate matrix2 with random numbers (using the same seed)
    for (int i = 0; i < numRows; ++i) {
        for (int j = 0; j < numCols; ++j) {
            matrix2[i][j] = dist(gen); // Generate a random number between 0 and 1
        }
    }
    // Populate matrix2 with random numbers (using the same seed)
    for (int i = 0; i < numRows; ++i) {
        for (int j = 0; j < numCols; ++j) {
            matrix3[i][j] = dist1(gen); // Generate a random number between 0 and 1
        }
    }
    ...
    // Print matrix3
    std::cout << "Matrix 3 (same seed, new instance):" << std::endl;
    for (int i = 0; i < numRows; ++i) {
        for (int j = 0; j < numCols; ++j) {
